...
(setq zephyr-syntax
	...
	( ,(regexp-opt '("SWAP" "DUP" "ZAP" "CAT" "UNCONS" "CONS" "I" "DIP" "ZIP-UP" "ZIP-DOWN" "CUR-TAG" "CUR-ATOM" "IFTE" "+" "==" "FAIL" "LENGTH" "ARG-HOLE" "ZIP-REPLACE" "LOG" "YIELD") 'word) . font-lock-builtin-face )
